export default function ProjectsLoading() {
  return (
    <div className="min-h-screen bg-base00 text-base05 flex flex-col">
      <main className="flex-1 w-full max-w-[1920px] mx-auto px-4 sm:px-8 md:px-12 pt-24 sm:pt-32 pb-8 sm:pb-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-6 sm:gap-8 lg:gap-10">
